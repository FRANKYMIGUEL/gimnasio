...
<div id="resultados_ticket" style="position:absolute;top:0px;left:0px;margin:0px;padding:0px;width:<?=$ancho?>px; height:<?=($con*60)+230+$altu?>px;border:0px solid; font:Arial, Helvetica, sans-serif; font-family:Arial, Helvetica, sans-serif;">
	...
	<div style="position:RELATIVE;left:0px;width:<?=$ancho?>px;text-align:left;">
      ...
      <div >
         ...
         if($row["tipo"]=="credito"){
         ?>
         <table style="text-align:left;font-size:10px; " border="0">
            <tr>
               <td colspan="2">DEBO(MOS) Y PAGARÉ(MOS) A LA ORDEN DE _______________________________________________<br> EN _______________ EL ____ DE _________ DE _____ <br> LA CANTIDAD DE $ ___________________ CON LETRA ____________________________ VALOR RECIBIDO</td>
            </tr>
            <tr>
               <td >A MI (NUESTRA) ENTERA SATISFACCÓN. ESTE PAGARÉ MERCANTIL Y ESTA REGIDO POR LA LEY GENERAL DE TITULOS Y OPERACIONES DE CREDITO EN SU ARTICULO 173 PARTE FINAL Y ARTICULOS, CORRELATIVOS POR NO SER PAGARÉ DOMICILIADO, SI NO ES LIQUIDADO A SU VENCIMIENTO CUSARA UN INTERES MORATORIO DEL ______% MENSUAL  </td>
               <td rowspan="2" align="center"> _______________<br> FIRMA DE CONFORMIDAD</td>
            </tr>
         </table>
         <?php
         }
