	...
	<div style="position:RELATIVE;left:0px;width:<?=$ancho?>px;text-align:left;">
        ...
        <table width="100%" style="font-size:12px;" border="0" cellpadding="0" cellspacing="0">
         ...
         if($reg["sabores"]!=''){
			...
			$SUBTOTALD=$SUBTOTAL;
			$TOTAL=$total;
         echo '<div style="text-align:left; width:100%; font-size:16px; text-align:right;"><b>Total Cotizacion &nbsp;&nbsp;&nbsp;<span style="float:right;"> $&nbsp;'.number_format($row["importe"],2,'.',',').'</span></b></div>';
			?>
			<div style="text-align:left; font-size:12px;">*<?=num2letras($TOTAL)?>*</div>
         <?php
         if($row["observaciones"]!=''){}
         ?>
         <div style="text-align:left;font-size:12px; ">&nbsp;Observaciones: <?=$row["observaciones"]?></div>
         <?
         ?>
